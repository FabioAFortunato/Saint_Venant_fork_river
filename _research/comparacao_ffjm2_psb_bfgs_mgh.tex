...
subproblem solver. Two scenarios are pregenered experiments, where the
...
$\sigma$-step). The Status column in Tables~\ref{tab:twin-dim2},
\ref{tab:twin-dim10}, \ref{tab:real-dim3}, and \ref{tab:real-dim10}
...
\begin{table}[htbp]
\centering
\caption{Twin experiment, $n_{grid}=2$: $\theta^\star=(0.20,\,0.15)$,
    $\theta^0=(0.09,\,0.09)$.}
\label{tab:twin-dim2}
\resizebox{\textwidth}{!}{%
...
\begin{table}[htbp]
\centering
\caption{Twin experiment, $n_{grid}=10$: decreasing profile $\theta^\star$
