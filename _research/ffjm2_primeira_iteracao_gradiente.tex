...
is already behaving like a backtracking line search along $-g$. Make a lineseach along $-g$ is a good optiom, becaus the next model will use a $\sigma_1 = \sigma_0/10$. If, the first step need to be small, $\sigma_0$ will be big and the next model can be afected. 
